...
```{r}
#Retroactive interference is the difference in accuracy (proportion of correct responses) in Phase 1 Block 5 and Phase 3 Block 1 separately for overlapping and unique pairs and then determining the difference between results for each pair type. 
#Savings is the difference in accuracy between Phase 1 Block 1 and Phase 3 Block 1, separately for overlapping and unique pairs. See Figure 2 for raw accuracy.
KeyAnalysis <- aov(accuracy ~ `pair type` * phase, data = Data)
